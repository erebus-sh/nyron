...
/**
 * Filter out meta commits (version bumps, changelog updates) from a list of commits.
 * These commits are typically generated by the versioning tool itself and shouldn't
 * appear in changelogs as they don't represent actual user-facing changes.
 * 
 * @param commits - Array of commits to filter
 * @returns Array of commits with meta commits removed
 */
